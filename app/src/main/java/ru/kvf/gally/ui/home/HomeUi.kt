...
import ru.kvf.favorite.ui.list.FavoriteListUi
        ...
        Box(
            ...
            Children(
                ...
                when (val child = it.instance) {
                    ...
                    is HomeComponent.Child.Favorite -> FavoriteListUi(child.component)
                    is HomeComponent.Child.Settings -> SettingsListUi(child.component)
                    is HomeComponent.Child.Design -> DesignUi(navigationBarHeight)
                }
            }
            Box(
                modifier = Modifier
